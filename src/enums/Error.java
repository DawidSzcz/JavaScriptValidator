...
public enum Error {
	InvalidBlock("Block after complex expression is missing","Brakuje bloku po z³o¿onej instrukcji"),
	...
	WrongNumberOfArguments("Wrong number of arguments","Nieprawid³owa iloœæ argumentów"),
	...
	InvalExpresionInParenthesis("Inval Expresion In Parenthesis","Nieprawid³owe wyra¿enie w nawiasie okrag³ym"),
	InvalidElseName("Invalid Else Name","Nieprawid³owa nazwa else-a"),
	InvalidElseIf("Invalid If in ElseIf","Nieprawid³owy \"if\" w \"else if\""),
	...
	InvalidCondition("Invalid Condition","Nieprawid³owy warunek"),
	...
	EnterInString("String is not properly terminated","String jest nie jest poprawnie zakoñczony"),
	...
	NullInBracket("No expresion in bracket","nie ma wyra¿enia w nawiasach"),
	...
	NoCaseInSwitch("No case in switch", "switch nie posiada casow"),
	...
	ExpectedVariableNotNumber("Expected variable not number","Liczba zamiast zmiennej"),
	...
	IncorrectMark("Incorrect mark","niepoprawny znak"),
